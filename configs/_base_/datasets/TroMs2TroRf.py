...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='TroMs/img_dir',
        ann_dir='TroMs/ann_dir',
        split='TroMs/TroMs.txt',
        B_img_dir='TroRf/img_dir',
        B_split='TroRf/TroRf.txt',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='TroRf/img_dir',
        ann_dir='TroRf/ann_dir',
        split='TroRf/TroRf.txt',
