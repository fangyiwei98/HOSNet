...
'''
这个脚本用于分析训练过程中的性能指标，如准确率、mIoU（平均交并比）等，并以图形化的方式展示出来，便于用户理解和分析模型的训练效果。
'''
import argparse
import json
...
def parse_args():
    ...
    parser.add_argument(
        '--json_logs',
        default='/data/fywdata/code/fyw/UDA/APANet/experiments/segformerb5/results_LoveDA/20240415_213148.log.json',
        type=str,
        nargs='+',
