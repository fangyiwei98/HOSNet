...
def parse_args():
    ...
    parser.add_argument('--dataset_path', default='/data/fywdata/ISPRSNEW/Potsdam_RGB/', help='potsdam folder path')
    parser.add_argument('--tmp_dir', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir', default='/data/fywdata/ISPRSNEW/Potsdam_RGB/',help='output path')
    parser.add_argument(
        '--clip_size',
        type=int,
